<template>
  <div class="register-overlay" @click="handleOverlayClick">
    <div class="register-modal" @click.stop>
      ...
      <div class="modal-footer">
        <a href="#" @click.prevent="showLogin">已有账号，去登录</a>
      </div>
    </div>
  </div>
</template>
...
import { register } from '@/service/common/api'
import { registerCaptcha } from '@/service/email/captcha'
...
const sendCaptcha = async () => {
  ...
  try {
    const res = await registerCaptcha(registerData.email)
