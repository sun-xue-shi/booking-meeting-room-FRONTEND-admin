  ...
  <div class="update-container">
    ...
    >
      ...
      <FormItem label="邮箱" name="email">
        <Input v-model:value="updatePasswordInfo.email" disabled />
      </FormItem>
...
import { getUserInfo, updatePassword } from "@/service/update/update";
...
async function getLoginInfo() {
  ...
  const { data } = res.data;
  updatePasswordInfo.value.email = data.email;
  updatePasswordInfo.value.username = data.username;
}
getLoginInfo();
